...
func EncryptBytes(rand io.Reader, key *PublicKey, msg []byte) (cipher []byte, err error) {
...
func DecryptBytes(key *PrivateKey, c []byte) ([]byte, error) {
...
func Decrypt(priv *PrivateKey, cipher []byte) (plaintext []byte, err error) {
	var C sm2Cipher
