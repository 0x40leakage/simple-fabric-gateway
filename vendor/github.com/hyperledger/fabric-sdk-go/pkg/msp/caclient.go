...
//  Parameters:
//  request holds info about CA
//
//  Returns:
//  Returns Certificate Revocation List
func (c *CAClientImpl) GenCRL(request *caapi.GenCRLRequest) (*api.GenCRLResponse, error) {
	...
	return c.adapter.GenCRL(registrar.PrivateKey(), registrar.EnrollmentCertificate(), request)
}
