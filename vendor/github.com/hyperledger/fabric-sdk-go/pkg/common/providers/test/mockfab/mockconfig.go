...
var GoodCert = &ccsX509.Certificate{Raw: []byte{0, 1, 2}}

// BadCert is a mock of a bad certificate
var BadCert = &ccsX509.Certificate{Raw: []byte{1, 2}}
...
var CertPool = ccsX509.NewCertPool()
...
func CustomMockConfig(mockCtrl *gomock.Controller, certPool *ccsX509.CertPool) *MockEndpointConfig {
	config := NewMockEndpointConfig(mockCtrl)
...
func (c *MockCertPool) Get() (*ccsX509.CertPool, error) {
	return c.CertPool, c.Err
}

//Add mock impl of adding certs to cert pool queue
func (c *MockCertPool) Add(certs ...*ccsX509.Certificate) {
